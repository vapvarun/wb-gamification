...
> **READ FIRST:** [`audit/manifest.json`](audit/manifest.json) is the canonical inventory — **63 REST endpoints**, **23 tables**, **19 blocks**, 17 shortcodes, ~10 cron hooks, **10 WP-CLI commands**, **14 admin pages**, **46 services**, **14 integrations** (12 manifest files + adapters; `audit/manifest.json#/integrations`), **0 admin_post_* handlers** (Tier 0 REST migration intact), **0 wp_ajax_* handlers**. Quick index: [`audit/manifest.summary.json`](audit/manifest.summary.json) (≤3 KB). Refresh via `/wp-plugin-onboard --refresh` after non-trivial changes. Stability gates: [`audit/STABILITY-2026-05-27.md`](audit/STABILITY-2026-05-27.md). Release gates (v1.5.3): WPCS clean, PHPStan level 9 clean, WP Plugin Check 0 errors, PHPUnit 154 tests green, all 16 local-CI stages green.
>
> **Folder map:**
