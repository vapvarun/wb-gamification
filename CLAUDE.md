...
> **READ FIRST:** [`audit/manifest.json`](audit/manifest.json) is the canonical inventory — **60 REST endpoints**, 20 tables, **15 blocks**, **15 shortcodes**, 9 cron hooks, 6 WP-CLI commands (`points`/`member` accept `--type=`), **12 admin pages**, **0 admin_post_* handlers** (Tier 0 REST migration), **0 wp_ajax_* handlers**, 85 fired hooks (54 actions + 31 filters), **2 currency tables** (`wb_gam_point_types` + `wb_gam_point_type_conversions`). Use this before grepping. Quick index: [`audit/manifest.summary.json`](audit/manifest.summary.json). wppqa baseline: [`audit/wppqa-baseline-2026-05-06/SUMMARY.md`](audit/wppqa-baseline-2026-05-06/SUMMARY.md) (failed=0).
>
> **Folder map:**
