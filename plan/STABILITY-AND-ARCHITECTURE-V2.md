...
GraphQL extension (WPGraphQL bridge)         shipped  ✓
ActivityPub Outbox projection                shipped  ✓
SSE stage 4-prep (operational docs)          shipped  ✓
SSE stage 4 (browser test + default flip)    needs Playwright
