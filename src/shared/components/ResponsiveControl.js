...
const DEVICES = [
	{ label: __( 'Desktop', 'wb-gamification' ), value: 'Desktop', icon: desktop },
	{ label: __( 'Tablet', 'wb-gamification' ), value: 'Tablet', icon: tablet },
	{ label: __( 'Mobile', 'wb-gamification' ), value: 'Mobile', icon: mobile },
];
...
export default function ResponsiveControl( { label, children, device, onDeviceChange } ) {
	...
	return (
		<BaseControl
			label={ label }
			className="wb-gam-responsive-control"
		>
			<div className="wb-gam-responsive-control__header">
				<ButtonGroup className="wb-gam-responsive-control__devices">
			...
			<div className="wb-gam-responsive-control__content">
